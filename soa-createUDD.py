...
def resetSubdeployTargetForConnectionFactories(track):
	if track == 'soa+bam':
		return
	elif track == 'soa':
	  	print ' '	
		print "Reseting the Sub Deployment target for BAM connection factories"
		cd ('/JMSSystemResource/BAMJMSModuleUDDs/JmsResource/NO_NAME_0/ConnectionFactory/BAMJMSConnectionFactory')
		set('SubDeploymentName', 'BAMJMSSubDM')
		set('DefaultTargetingEnabled', 'false')
	elif track == 'bam':
	  	print ' '	
		print "Reset the Sub Deployment target for SOA connection factories"

		cd ('/JMSSystemResource/SOAJMSModuleUDDs/JmsResource/NO_NAME_0/ConnectionFactory/TestFwkQueueFactory')
		set('SubDeploymentName', 'SOAJMSSubDM')
		set('DefaultTargetingEnabled', 'false')
...
#resetSubdeployTargetForConnectionFactories(track)
